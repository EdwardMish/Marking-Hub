                            ...
                            <div class="col-lg-12">
                                <div class="ibox">
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="fullname" class="inputs-label">Name on card</label>
                                                    <input type="text" class="form-control  custom-input" name="fullname"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="card_number"
                                                           ...
                                                           name="card_number" placeholder="1234 1234 1234 1234">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="card_number" name="cvv"
                                                           class="form-control custom-input"
                                                           placeholder="CVC">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="card_number" class="inputs-label">Expiration
                                                        Date</label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <p class="faded-text" style="margin: 0;">This card will be used for all
                                                    future Simplepost purchases</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="street_address" name="address1"
                                                           class="form-control custom-input mb-10"
                                                           placeholder="Street address">
                                                    <input type="text" id="street_address2" name="address2"
                                                           class="form-control custom-input"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="state"
                                                           class="inputs-label">State/Province/Region</label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control custom-input" id="country_select" name="country">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="zip" class="inputs-label">Postal/Zip
                                                        Code</label>
                                                    <input type="text" id="zip" name="zip"
                                                           class="form-control custom-input" placeholder="e.g. 01234">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
