<div class="col-lg-12">
    <div class="ibox ">
        <div class="ibox-title">
            <h5>Step 2: Design Your Postcard</h5>
        </div>
        ...
        <div class="ibox-content" id="designPostcardContent">
                ...
                <div class="modal-dialog modal-90">
                    <div class="modal-content">
                        ...
                        <div style="height: 30px; margin: 18px 25px">
                            <button onclick="saveDesign()" id="savePostCard" type="button" class="btn btn-lg btn-primary pull-right">Save & Continue</button>
                        </div>
