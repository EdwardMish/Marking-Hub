                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="average-order-size" class="form-control custom-input" value="150">
                        </div>
                    </div>
                </div>
                <div class="row mt-20">
    ...
    <script>
        $(document).ready(function () {
            ...
            function updateCalculator() {
                ...
                additionalRevenue.innerText = '$' + Math.ceil(averageOrderSize * incrementalOrders.innerText);
